...
const int YEARLY_BLOCKCOUNT = 350400;	// 365 * 960
int64 GetProofOfStakeReward(int64 nCoinAge, unsigned int nBits, unsigned int nTime, int nHeight)
{
	...
	if(nHeight < YEARLY_BLOCKCOUNT)
        nRewardCoinYear = 10 * MAX_MINT_PROOF_OF_STAKE;////////第一年1%
	else if(nHeight < (2 * YEARLY_BLOCKCOUNT))
        nRewardCoinYear = 8 * MAX_MINT_PROOF_OF_STAKE;////////第二年0.8%
	else if(nHeight < (3 * YEARLY_BLOCKCOUNT))
        nRewardCoinYear = 6 * MAX_MINT_PROOF_OF_STAKE;////////第三年0.6%
	else if(nHeight < (4 * YEARLY_BLOCKCOUNT))
        nRewardCoinYear = 4 * MAX_MINT_PROOF_OF_STAKE;////////第四年0.4%
	else if(nHeight < (5 * YEARLY_BLOCKCOUNT))
        nRewardCoinYear = 2 * MAX_MINT_PROOF_OF_STAKE;////////第五年0.2%
